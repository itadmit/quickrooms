...
export default function MemberLayout({
  ...
  const menuItems = [
    { href: "/dashboard/member", label: "סקירה כללית", icon: LayoutDashboard },
    { href: "/dashboard/member/rooms", label: "חדרים זמינים", icon: Building2 },
    { href: "/dashboard/member/bookings", label: "ההזמנות שלי", icon: Calendar },
    { href: "/dashboard/member/credits", label: "יתרת קרדיט", icon: CreditCard },
  ];
        ...
        <div className="p-4 border-t border-gray-100 space-y-1">
          <Link
            ...
            className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all ${
              pathname.startsWith('/dashboard/member/settings')
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-4 lg:px-8 shadow-sm z-20">
          ...
          <div className="hidden lg:flex items-center w-96 relative">
            ...
            <input 
              type="text" 
              placeholder="חיפוש חדרים או הזמנות..." 
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="hidden md:block text-right">
                  <div className="text-sm font-semibold text-gray-900 group-hover:text-indigo-600 transition-colors">{memberName}</div>
